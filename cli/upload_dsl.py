...
class StructurizrClient:
    """Client for Structurizr interactions"""
...
def main():
    ...
    # initialise class for structurizr details
    structurizr_upload = StructurizrClient()
...
"""
    ...
    success = structurizr_upload.upload_dsl_file(
